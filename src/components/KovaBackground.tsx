...
export function KovaBackground() {
  ...
  return (
    <div className="kova-background" aria-hidden="true">
      <motion.div className="kova-background__wash" style={lowTier ? undefined : { opacity: washOpacity }} />
      <motion.div className="kova-background__scene" style={lowTier ? undefined : { y: sceneY, scale: sceneScale }}>
        <motion.div
          className="kova-background__orb kova-background__orb--one"
          animate={lowTier ? undefined : { x: [0, 28, -12, 0], y: [0, -20, 14, 0], scale: [1, 1.05, 0.98, 1] }}
          transition={{ duration: 24, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="kova-background__orb kova-background__orb--two"
          animate={lowTier ? undefined : { x: [0, -24, 10, 0], y: [0, 18, -10, 0] }}
          transition={{ duration: 30, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="kova-background__line kova-background__line--one"
          animate={lowTier ? undefined : { rotate: [0, 2, -1, 0], opacity: [0.2, 0.34, 0.2] }}
          transition={{ duration: 18, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="kova-background__line kova-background__line--two"
          animate={lowTier ? undefined : { rotate: [0, -2, 1, 0], opacity: [0.12, 0.25, 0.12] }}
