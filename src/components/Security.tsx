...
const principles = [
  { title: "Your training stays yours", description: "Your workout history and progress stay easy to manage and access." },
  { title: "Health data with intention", description: "Connect Apple Health on your iPhone when you choose." },
  { title: "Clear account controls", description: "Export your data and manage your account at any time." },
];
